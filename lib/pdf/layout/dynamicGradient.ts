// lib/pdf/layout/dynamicGradient.ts
// SINGLE-PAGE OPTIMIZED - Dynamic gradient design
  ...
  <style>
    * {
    ...
    .job-item {
      margin-bottom: 8pt;
      padding-left: 10pt;
      border-left: 3pt solid ${config.colors.primary}20;
    ...
    .skill-tag {
      font-size: 8.5pt;
      padding: 5pt 12pt;
      background: linear-gradient(135deg, ${config.colors.primary}15 0%, ${config.colors.secondary || config.colors.primary}10 100%);
      color: ${config.colors.primary};
      border-radius: 12pt;
      font-weight: 500;
